...
const FeatureCard = ({ data }: { data: Feature }) => {
  ...
  return (
    ...
    >
      ...
      <Link href="">
        {isHighlight ? (
          <PrimaryButtonDefault className="px-16 font-normal">Learn More</PrimaryButtonDefault>
        ) : (
          <SecondaryButtonDefault className="px-16 font-medium">Learn More</SecondaryButtonDefault>
        )}
      </Link>
    </div>
  );
